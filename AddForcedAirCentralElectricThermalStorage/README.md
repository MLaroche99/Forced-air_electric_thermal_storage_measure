...
## Modeler Description
Code modified by M. Mathieu Laroche, developed by M. Houssem Eddine Younes, M.Sc. Supervised by Mme. Katherine DAvignon, Ph.D  & M. François Laurencelle, Ph.D. Funded by Mitacs Inc and Hydro-Québec.
...
### Enter device maximum discharge rate (Pheat,test)[kW]:
...
### Enter the brick core temperature deadband [°C]:
